...
RULE_REMEDIATION_HINTS: Dict[str, str] = {
    ...
    "mutation-config-missing": "Configure quality.mutation_testing.runner and tool-specific settings in .specify/policy.yml.",
    "mutation-runner-error": "Verify mutation adapter command/report settings and confirm the selected mutation tool is available.",
    "mutation-runner-crashed": "Inspect mutation adapter configuration and parser compatibility for the selected runner.",
    "mutation-report-parse-failed": "Adjust mutation report output/configuration so results can be parsed into canonical schema.",
    "mutation-command-failed": "Inspect mutation tool stderr and command configuration before rerunning gates.",
    "mutation-score-below-threshold": "Strengthen tests around behavior, boundaries, and side effects to kill surviving mutants.",
    "mutation-survived": "Add precise assertions for concrete outcomes and boundary cases around this mutant location.",
    "mutation-no-coverage": "Add a test that executes this path before tuning assertions.",
...
RULE_DEFAULT_META: Dict[str, Dict[str, str]] = {
    ...
    "mutation-config-missing": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-runner-error": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-runner-crashed": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-report-parse-failed": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-command-failed": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-score-below-threshold": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-survived": {"confidence": "heuristic", "remediation_owner": "feature-team"},
    "mutation-no-coverage": {"confidence": "heuristic", "remediation_owner": "feature-team"},
}
