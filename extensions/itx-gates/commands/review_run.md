---
description: "Run the Spec-Kit review extension via the universal runner adapter"
---

## Purpose

Execute `/speckit.review.run` by delegating to the installed `spec-kit-review`
...
This delegates to `ismaelJimenez/spec-kit-review`. The community extension
defines what review checks to run and how results are reported.
